...
DB_URI_SECRET_ARN="${DB_URI_SECRET_ARN:-arn:aws:secretsmanager:us-east-1:008701887645:secret:postgres-mcp-demo-dev/demo-postgres-mcp/admin-database-uri-JY4Al3}"
