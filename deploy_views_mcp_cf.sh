...
DATABASE_URI="${DATABASE_URI:-postgresql://text_to_sql_views_ro:rIiUfKVhDmNMR5IEaSNzLQ2GVzv6d4nl@postgres-mcp-demo-dev-demo-postgres-mcp.cdzohpfba5bv.us-east-1.rds.amazonaws.com:5432/demo_postgres_mcp}"
